...
async function main() {
  ...
  const categories = await Promise.all([
    ...
    prisma.tourCategory.create({
      data: {
        ...
        image: "https://images.unsplash.com/photo-1568625502763-2a5ec6a94c47?w=800&h=600&fit=crop",
      },
    }),
  ]);
  ...
  const tours = await Promise.all([
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1549366021-9f761d450615?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1549366021-9f761d450615?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1549366021-9f761d450615?w=600&h=400&fit=crop"],
        featured: true,
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1517960413843-0aee8e2b3285?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1517960413843-0aee8e2b3285?w=800&h=600&fit=crop"],
        featured: true,
        categoryId: wildlifeCat.id,
      },
    }),
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1530866495561-507c83091b04?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1530866495561-507c83091b04?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1530866495561-507c83091b04?w=600&h=400&fit=crop"],
        featured: true,
        categoryId: adventureCat.id,
      },
    }),
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1534177616064-76c28f23711e?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1534177616064-76c28f23711e?w=800&h=600&fit=crop"],
        featured: false,
        categoryId: adventureCat.id,
      },
    }),
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1523805009345-7448845a9e53?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1523805009345-7448845a9e53?w=800&h=600&fit=crop"],
        featured: true,
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=800&h=600&fit=crop"],
        featured: false,
        categoryId: culturalCat.id,
      },
    }),
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=600&h=400&fit=crop"],
        featured: true,
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&fit=crop"],
        featured: false,
        categoryId: cruiseCat.id,
      },
    }),
    ...
    prisma.tour.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1568625502763-2a5ec6a94c47?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1568625502763-2a5ec6a94c47?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1568625502763-2a5ec6a94c47?w=600&h=400&fit=crop"],
        featured: true,
  ...
  const accommodations = await Promise.all([
    prisma.accommodation.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop"],
        rating: 4.8,
        featured: true,
      },
    }),
    prisma.accommodation.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=800&h=600&fit=crop"],
        rating: 4.3,
        featured: true,
      },
    }),
    prisma.accommodation.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=800&h=600&fit=crop"],
        rating: 4.5,
        featured: false,
      },
    }),
    prisma.accommodation.create({
      data: {
        ...
        images: ["https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&h=600&fit=crop"],
        rating: 4.1,
        featured: false,
      },
    }),
  ...
  const roomTypes = await Promise.all([
    ...
    prisma.roomType.create({
      data: {
        ...
        maxOccupancy: 2,
        images: ["https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=1200&h=800&fit=crop"],
      },
    }),
    // Zambezi Guesthouse
    prisma.roomType.create({
      data: {
        ...
        maxOccupancy: 1,
        images: ["https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=800&h=600&fit=crop"],
      },
    }),
    prisma.roomType.create({
      data: {
        ...
        maxOccupancy: 2,
        images: ["https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=1200&h=800&fit=crop"],
      },
    }),
  ...
  await Promise.all([
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1568625502763-2a5ec6a94c47?w=800&h=600&fit=crop", caption: "Aerial view of Victoria Falls in full flow", category: "Victoria Falls", order: 1 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=800&h=600&fit=crop", caption: "Double rainbow over Victoria Falls", category: "Victoria Falls", order: 2 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&h=600&fit=crop", caption: "Golden sunset over the Zambezi River", category: "River", order: 3 } }),
    ...
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=800&h=600&fit=crop", caption: "The dramatic Batoka Gorge below the falls", category: "Scenery", order: 11 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1517960413843-0aee8e2b3285?w=800&h=600&fit=crop", caption: "African fish eagle on the Zambezi", category: "Wildlife", order: 12 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop", caption: "Takonray River Lodge at dusk", category: "Accommodation", order: 13 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=800&h=600&fit=crop", caption: "The historic Livingstone Museum", category: "Culture", order: 14 } }),
    prisma.galleryImage.create({ data: { url: "https://images.unsplash.com/photo-1534177616064-76c28f23711e?w=800&h=600&fit=crop", caption: "Giraffe in Mosi-oa-Tunya National Park", category: "Wildlife", order: 15 } }),
  ]);
  ...
  await Promise.all([
    ...
    prisma.siteSetting.create({ data: { key: "contact_phone", value: "+260974600016" } }),
    prisma.siteSetting.create({ data: { key: "contact_whatsapp", value: "+260974600016" } }),
